...
// Vectors/Matrices Needed for Calculation of Output Layer Gradients
    ...
    // cudaMemset(d_dbOutput, 0, sizeof(double));
...
////////////////////////////////////////////////////////////////////////
    ...
    // cudaMemset(d_db2, 0, sizeof(double));
...
// Vectors/Matrices Needed for Calculation of First Layer Gradients
    ...
    // cudaMemset(d_db1, 0, sizeof(double));
...
void train_GPU(NeuralNetwork_GPU* d_nn,
	...
	// Initialize double for accuracy
	double accuracy;
	...
	do {
	    printf("Epoch %d:\n", epoch);
	    for (int i = 0; i < d_X->rows; i += batch_size) {
